    ...
    <div className="h-screen w-full flex">
      <div className="h-full k w-1/2">
        <div className="w-full h-full bg-mint flex flex-col justify-center  text-black">
          <h1 className="uppercase font-cinzel flex items-center font-extrabold p-4 text-5xl  text-black  tracking-wider">
            Oni Real Estate{" "}
            <div className="w-36 ml-4 h-0 border-2 border-white"></div>
          </h1>
          <h3 className="p-4 text-2xl uppercase font-cinzel font-bold tracking-wider">
            Our Purpose
          </h3>

          <p className="text-md font-montserrat tracking-wide text-left p-4">
