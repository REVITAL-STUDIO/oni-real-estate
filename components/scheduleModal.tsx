...
const ScheduleModal: React.FC<{ handleClose: () => void }> = ({ handleClose }) => {
            ...
            >
                ...
                >
                    ...
                    <div className="w-full h-[95%] flex flex-col justify-center items-center z-100">
                        ...
                        {isSuccess ? <div className="text-3xl">Message Sent!</div> :
                            <form onSubmit={createLead} className="bg-transparent rounded  w-3/4 h-5/6 text-gray-300">
                                {/* First Name */}
                                <div className="mb-4">
                                    <label
